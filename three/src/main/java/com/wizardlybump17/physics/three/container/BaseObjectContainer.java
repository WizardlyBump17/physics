...
public abstract class BaseObjectContainer implements Tickable {
    ...
    public abstract @NotNull Collection<ObjectsGroup> getObjectsGroups();

    public abstract void addGroup(@NotNull ObjectsGroup group);

    public abstract boolean hasGroup(int groupId);

    public boolean hasGroup(@NotNull ObjectsGroup group) {
